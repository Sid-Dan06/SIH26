            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return InkWell(
                    onTap: () =>
                        setState(() => selectedSkill = item['name'] as String),
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(
                            ...
                            color:
                                isSelected ? AppColors.purple : AppColors.muted,
                            size: 20,
                          ),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        selectedOption == 0 ? AppColors.lavender : Colors.white,
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        selectedOption == 1 ? AppColors.lavender : Colors.white,
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
